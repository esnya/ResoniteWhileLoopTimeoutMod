...
2. Download the latest `WhileLoopTimeout.dll` from the [Releases page](https://github.com/esnya/ResoniteWhileLoopTimeoutMod/releases/latest) and place it in the `rml_mods` folder inside your Resonite install (e.g., `C:\Program Files (x86)\Steam\steamapps\common\Resonite\rml_mods`). Create the folder if it does not exist.
